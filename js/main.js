...
var onlineusers = document.getElementById("insert-users");
 ...
 onlineusers.innerHTML += '<li id="'+ParentDiv+'" class="clearfix"> <img class="avatarimg" onclick="BigPicture({ el: this, imgSrc: '+quoatedpic+' })"  src="/Firebase-Group-Chat--Javascript/'+userpic+'" alt="avatar" /> <div class="about"> <div class="name">'+activeusername+'</div> <div style="font-family:Amaranth;" id="'+idofactiveuser+'" title="User Is Currently Viewing Messages." class="status">  <center><img src="/Firebase-Group-Chat--Javascript/loadingicon.gif" style="width:30px; height:30px; border-radius:50%; position:absolute;"></center></div> </div> </li>'
...
//alert(styletag)
 ...
 insertedchat.innerHTML += '<div  comment="'+keyofthiscomment+'" id="parentofmsg"> <li class="clearfix"> <div class="message-data align-right"> <span  data-toggle="tooltip" data-placement="top" title="'+msgtime+", "+msgdate+'" class="message-data-time"> Today at '+msgtime+'</span> &nbsp; &nbsp; <span title="'+'Nickname: '+thenick+'" class="message-data-name">'+nameofuser+'</span> <i class="fa fa-circle me"> <img width="50px" style="'+styleforpic+'"  onclick="BigPicture({ el: this, imgSrc: '+quoatedimage+' })" class="avatarr" src="/Firebase-Group-Chat--Javascript/'+imageofuser+'"> </i> </div> <div class="message other-message float-right animated " style="text-shadow: 0px 0px 3px black;" > '+messageofuser+' </div> </li>  <br> <div class="dropdown dropdowndiv left adminrights"> <a class="aofdropdown lefta" href="/Firebase-Group-Chat--Javascript/javascript:void(0)" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i> <i class="icon-arrow"></i></a> <div class="dropdown-menu menuofdropdown leftmenu">  <li><a class="adminrights" onclick="deletemsg('+quoatedsnapkey+')" href="/Firebase-Group-Chat--Javascript/javascript:void(0)"> Delete MSG </a></li> <li><a class="adminrights" onclick="'+userdetailsfunction+'" href="/Firebase-Group-Chat--Javascript/javascript:void(0)">User Details</a></li> </div> </div> </li></div>';
            
        }
        else{
        //If message was sent before today.
        insertedchat.innerHTML += '<div comment="'+keyofthiscomment+'" id="parentofmsg">  <li class="clearfix"> <div class="message-data align-right"> <span datetime="'+msgdate+'" data-toggle="tooltip" data-placement="top" title="'+msgtime+", "+msgdate+'" class=" message-data-time"> '+msgtime+", "+msgdate+' </span> &nbsp; &nbsp; <span title="'+'Nickname: '+thenick+'" class="message-data-name">'+nameofuser+'</span> <i class="fa fa-circle me"> <img width="50px" style="'+styleforpic+'"  onclick="BigPicture({ el: this, imgSrc: '+quoatedimage+' })"  class="avatarr" src="/Firebase-Group-Chat--Javascript/'+imageofuser+'"> </i> </div> <div class="message other-message float-right animated "  style="text-shadow: 0px 0px 3px black;" > '+messageofuser+' </div> </li>  <br> <div class="dropdown dropdowndiv left adminrights"> <a class="aofdropdown lefta" href="/Firebase-Group-Chat--Javascript/javascript:void(0)" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i> <i class="icon-arrow"></i></a> <div class="dropdown-menu menuofdropdown leftmenu"> <li><a href="/Firebase-Group-Chat--Javascript/#">Ignore User</a> <li><a onclick="'+blockuserip+'" href="/Firebase-Group-Chat--Javascript/javascript:void(0)" class="adminrights">Block User</a></li> <li><a  class="adminrights" href="/Firebase-Group-Chat--Javascript/javascript:void(0)" onclick="deletemsg('+quoatedsnapkey+')">Delete MSG</a></li> <li><a  class="adminrights" onclick="'+userdetailsfunction+'" href="/Firebase-Group-Chat--Javascript/javascript:void(0)">User Details</a></li> </div> </div> </li></div>';
 ...
 //if message was sent today := 
 insertedchat.innerHTML += '<div ignoreid="'+data.child("UserId").val()+'" comment="'+keyofthiscomment+'" id="parentofmsg"><div > <li> <div class="message-data animated fadeIn"> <img class="avatarr" style="'+styleforpic+'" onclick="BigPicture({ el: this, imgSrc: '+quoatedimage+' })"  src="/Firebase-Group-Chat--Javascript/'+imageofuser+'"> <span title="'+'Nickname: '+thenick+'" class="message-data-name"><i class="fa fa-circle online"></i> '+nameofuser+'</span> <span  data-toggle="tooltip" title="'+msgtime+', '+msgdate+'" class="message-data-time">Today at '+msgtime+'</span> </div> <div class="message my-message animated "   style="'+styletag+'" > '+messageofuser+' </div> </li> <!--Menu--> <div style="'+stylenone+'" class="'+adminclass+'"> <a class="aofdropdown righta" onclick="" href="/Firebase-Group-Chat--Javascript/#" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i> <i class="icon-arrow"></i></a> <div style="" class="dropdown-menu menuofdropdown rightmenu"> <li><a onclick='+ignorefunction+'                   href="/Firebase-Group-Chat--Javascript/javascript:void(0)">Ignore User</a></li> <li><a class="adminrights"  onclick="'+blockuserip+'" href="/Firebase-Group-Chat--Javascript/javascript:void(0)">Block User</a></li> <li><a class="adminrights" onclick="deletemsg('+quoatedsnapkey+')" href="/Firebase-Group-Chat--Javascript/javascript:void(0)">Delete MSG</a></li> <li><a  onclick="'+userdetailsfunction+'" class="adminrights" href="/Firebase-Group-Chat--Javascript/javascript:void(0)">User Details</a></li> </div> </div> </div></div>';
            
        }
        else{
        //If message was sent before today.
        insertedchat.innerHTML += '<div comment="'+keyofthiscomment+'" ignoreid="'+data.child("UserId").val()+'"   id="parentofmsg"><div > <li> <div class="message-data animated fadeIn"> <img class="avatarr" style="'+styleforpic+'" onclick="BigPicture({ el: this, imgSrc: '+quoatedimage+' })"  src="/Firebase-Group-Chat--Javascript/'+imageofuser+'"> <span title="'+'Nickname: '+thenick+'" class="message-data-name"><i class="fa fa-circle online"></i> '+nameofuser+'</span> <span data-toggle="tooltip" title="'+msgtime+', '+msgdate+'" datetime="'+msgdate+'" class="message-data-time ">'+msgtime+", "+msgdate+'</span> </div> <div class="message my-message animated " style="'+styletag+'" > '+messageofuser+' </div> </li> <!--Menu--> <div  class="'+adminclass+'"> <a class="aofdropdown righta" onclick="" href="/Firebase-Group-Chat--Javascript/#" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i> <i class="icon-arrow"></i></a> <div style="" class="dropdown-menu menuofdropdown rightmenu">  <li><a onclick="ignorethisuser('+quoateduserid+')"  href="/Firebase-Group-Chat--Javascript/javascript:void(0)">Ignore User</a> <li><a onclick="'+blockuserip+'" href="/Firebase-Group-Chat--Javascript/javascript:void(0)" class="adminrights">Block User</a></li> <li onclick="deletemsg('+quoatedsnapkey+')" class="adminrights"><a href="/Firebase-Group-Chat--Javascript/javascript:void(0)" >Delete MSG</a></li> <li><a class="adminrights"  onclick="'+userdetailsfunction+'" href="/Firebase-Group-Chat--Javascript/javascript:void(0)">User Details</a></li> </div> </div> </div></div>';
